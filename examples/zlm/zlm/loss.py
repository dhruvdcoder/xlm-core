...
from .types import ZLMBatch, ZLMLossDict, ZLMModel
...
class ZLMLoss(LossFunction[ZLMBatch, ZLMLossDict]):
    """Loss function for Auto-Regressive Language Modeling (ZLM).
    ...
    def __init__(
        ...
        """Initialize the ZLM loss function.
    ...
    def configure(self, pl_module: Harness):
        ...
        """
        pass  # nothing to configure for ZLM
