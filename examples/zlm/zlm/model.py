...
########################################################
# region: ZLM Transformer


class RotaryTransformerZLMModel(torch.nn.Module):
    ...
    def __init__(
        ...
        """Initialize the ZLM transformer model.
