...
class DreamRotaryEmbedding(nn.Module):
    def __init__(
        ...
        scaling_factor=1.0,
        rope_type="default",
        config: Optional[DreamConfigBase] = None,
    ):
        super().__init__()
...
class DreamAttention(nn.Module):
    ...
    def __init__(self, config: DreamConfigBase, layer_idx: Optional[int] = None):
        super().__init__()
        self.config = config
...
class DreamDecoderLayer(nn.Module):
    def __init__(self, config: DreamConfigBase, layer_idx: int):
        super().__init__()
        self.hidden_size = config.hidden_size
...
class DreamBaseModel(DreamPreTrainedModel):
    ...
    def __init__(self, config: DreamConfigBase):
...
class DreamModelCore(DreamPreTrainedModel):
