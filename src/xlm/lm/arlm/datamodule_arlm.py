...
from .types_arlm import ARLMBatch, ARLMSeq2SeqBatch
...
class ARLMSeq2SeqCollator:
    ...
    def __call__(
        ...
        # Create target_ids (shifted by 1 for next token prediction)
        # For ARLM seq2seq, target_ids are shifted left by 1
        target_ids = []
...
class ARLMSeq2SeqPredCollator(ARLMSeq2SeqCollator):
