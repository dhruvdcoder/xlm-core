...
from .generation_dreamon import DreamOnGenerationConfig, DreamOnGenerationMixin


class DreamOnModel(DreamOnGenerationMixin, DreamModelCore):
    ...
    def from_pretrained(
        ...
        **kwargs,
        ...
        _model.generation_config = DreamOnGenerationConfig.from_pretrained(
            pretrained_model_name_or_path,
            cache_dir=cache_dir,
            force_download=force_download,
