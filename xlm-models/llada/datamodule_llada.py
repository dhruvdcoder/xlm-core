...
def openmath_preprocess_fn(
    ...
    *,
    ...
    p_ids = tokenizer.encode(problem, add_special_tokens=False)
    a_ids = tokenizer.encode(solution, add_special_tokens=False)
    ...
    if len(prompt_token_ids) >= max_length:
        ...
        a_ids = a_ids[:budget]
    example["prompt_token_ids"] = prompt_token_ids
